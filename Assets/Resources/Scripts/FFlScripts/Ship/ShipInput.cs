...
namespace FLFlight
{
    ...
    public class ShipInput : MonoBehaviour
    {
        ...
        [Tooltip("Cursor used for the ship")] [SerializeField]
        private Transform cursorPoistion;
        ...
        /// </summary>
        private void UpdateKeyboardThrottle()
        {
